        ...
        <div className="card">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-semibold text-white">Add AI Tool</h2>
            </div>
            <button
          ...
          <p className="text-sm text-gray-400 mb-4">
            Enter the tool name and optionally URL. AI will search the web and auto-generate
            the complete profile with real data.
          </p>
          ...
          {!bulkMode ? (
            ...
            <div className="space-y-4">
              <textarea
                ...
                className="input-dark h-40 resize-y font-mono text-sm"
                disabled={isAdding}
              />
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-500">
                  {bulkInput.split("\n").filter((l) => l.trim()).length} tools to add
                </span>
                <button
              ...
              {bulkProgress.length > 0 && (
                <div className="bg-gray-800 rounded-xl p-4 text-sm font-mono text-emerald-400 max-h-60 overflow-y-auto border border-gray-700">
